...
displayReviews();
// When a user clicks on the description, toggle the input box
const descriptionP = document.querySelector('.description');
descriptionP.addEventListener('click',(event) => {
  toggleDescriptionEdit(descriptionP);
})
...
// save the review adn display it
...
function saveReview() {
  ...
  const reviewerTitle = document.getElementById('title').value;
  const reviewerRating = document.getElementById('rating').value;
  const reviewerReview = document.getElementById('review').value;
