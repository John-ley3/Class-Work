...
*/
		function seeColor(x){
			let strBlue = x.substr(0, 4);
			let strRed = x.substr(0, 3);
...
*/
		function frontAgain(x){
			let frontStr = x.substr(0, 2);
			let endStr = x.substring(x.length - 2);
...
*/
		function createObject(){
			obj = {firstName: "John", lastName: "Ley", age:21};
			return obj;
		}