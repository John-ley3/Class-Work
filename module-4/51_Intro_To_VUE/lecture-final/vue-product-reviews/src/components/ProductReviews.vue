...
<div class="well">
    ...
    5 Star Review{{ numberOfFiveStarReviews === 1 ? '' : 's' }}
      ...
      <div class="review" v-bind:class="{favorited:reviewObject.favorited}" v-for="reviewObject in reviews" v-bind:key="reviewObject.reviewer">
          <h4>{{reviewObject.reviewer}}</h4>
          <div class="rating" v-for="i in reviewObject.rating" v-bind:key="i">
              <img src="../assets/star.png"/>
           </div>
              <h3>{{reviewObject.title}}</h3>
              <p>{{reviewObject.review}}</p>
              <p>Favorite? <input type="checkbox" v-model="reviewObject.favorited"/></p>
          </div>
