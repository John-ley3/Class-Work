        ...
        public static void UsingTheDirectoryClass()
        {
            ...
            if(!directoryExists)
            {
                ...
                try
                {
                    ...
                    string[] subDirectories = Directory.GetDirectories(@"C:\TestDirectory\SubDirectory\Test1");
                } catch(Exception)
                {
                    // Getting a list of directories within a directory
                    // One could write a for-loop to print each directory out
                    Directory.CreateDirectory(@"C:\TestDirectory\SubDirectory\Test1");
                    Directory.CreateDirectory(@"C:\TestDirectory\SubDirectory\Test2");
                    Directory.CreateDirectory(@"C:\TestDirectory\SubDirectory\Test3");
                ...
                {
                    Console.WriteLine("Directory isn't empty, delete anyway? y/n");
                    ...
                    if(input.StartsWith("y"))
                    {
                        ...
                        {
                            Console.WriteLine("Sorry, Dave, I cannot do that.");
                        }
                    }
