...
namespace HTTP_Web_Services_GET_lecture
{
    class Program
    {
        private static readonly APIService apiService = new APIService("https://localhost:44322/api/");
        ...
        private static void MenuSelection()
        {
            ...
            while (menuSelection != 0)
            {
                ...
                {
                    Console.Clear();
                    console.PrintCity(apiService.GetPublicAPIQuery());
                }
